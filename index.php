...
<head>
    <title><? echo lang('welcome'); ?> | socalled</title>
    <meta charset="UTF-8">
    <meta name="description" content="socalled is a social network platform helps you meet new friends and stay connected with your family and with who you are interested anytime anywhere.">
    <meta name="keywords" content="homepage,main,login,social network,social media,socalled,meet,free platform">
    ...
    <!--============[ Nav bar ]============-->
        <div class="login_signup_navbar">
                <a href="index" class="login_signup_navbarLinks">socalled</a>
        ...
        <h3 align="center"><? echo lang('welcome_to'); ?> socalled</h3>
        <p align="center" style="color: #999; margin-bottom: 25px;"><? echo lang('socalled_main_string'); ?>.</p>
            <div style="display: flex;">
                ...
                <div style="width: 100%;text-align: center;">
                    <img src="imgs/main_icons/pc_main.png" alt="socalled" style="width: 300px;" />
                </div>
            </div>
        </div>
